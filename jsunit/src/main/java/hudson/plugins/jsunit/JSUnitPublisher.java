 ...
 * @author Erik Ramfelt
 */
public class JSUnitPublisher extends hudson.tasks.Publisher implements Serializable {
        ...
        try {
            ...
            if (result) {
                ...
                if (keepJUnitReports) {
                    ...
                    build.getProject().getWorkspace().child(JSUnitArchiver.JUNIT_REPORTS_PATH).deleteRecursive();
                }
            }
