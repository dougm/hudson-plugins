...
// -------------------------- STATIC METHODS --------------------------
     ...
     */
    public static boolean doPerform( Ghostwriter ghostwriter, AbstractBuild<?, ?> build, BuildListener listener )
        throws IOException, InterruptedException
    {
        ...
        if ( ghostwriter instanceof Ghostwriter.SlaveGhostwriter )
        {
            ...
            BuildProxy buildProxy = new BuildProxy( new FilePath( build.getArtifactsDir() ),
                                                    new FilePath( build.getProject().getRootDir() ),
                                                    new FilePath( build.getRootDir() ),
                                                    build.getProject().getModuleRoot(), build.getTimestamp() );
        ...
        return masterGhostwriter == null || masterGhostwriter.performFromMaster( build,
     ...
     */
    private static RuntimeException unwrapException( Exception e, BuildListener listener )
        throws IOException, InterruptedException
    {
     ...
     * @throws InterruptedException on InterruptedException.
     */
    public static boolean doPerform( Ghostwriter ghostwriter, MavenBuildProxy mavenBuildProxy, MavenProject pom,
        ...
        throws InterruptedException, IOException
    {
        ...
        BuildProxy buildProxy = new BuildProxy( mavenBuildProxy.getArtifactsDir(), mavenBuildProxy.getProjectRootDir(),
                                                mavenBuildProxy.getRootDir(), new FilePath( pom.getBasedir() ),
...
// --------------------------- CONSTRUCTORS ---------------------------
     ...
     */
    private BuildProxy( FilePath artifactsDir, FilePath projectRootDir, FilePath buildRootDir,
                        FilePath executionRootDir, Calendar timestamp )
    {
