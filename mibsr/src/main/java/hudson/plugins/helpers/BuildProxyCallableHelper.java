...
class BuildProxyCallableHelper
    implements Callable<BuildProxy, Exception>, MavenBuildProxy.BuildCallable<Boolean, Exception>
{
    // ------------------------------ FIELDS ------------------------------
     ...
     * {@inheritDoc}
     */
    public Boolean call( MavenBuild mavenBuild )
        throws Exception
    {
        buildProxy.updateBuild( mavenBuild );
        if ( ghostwriter instanceof Ghostwriter.MasterGhostwriter )
        {
            final Ghostwriter.MasterGhostwriter masterBuildStep = (Ghostwriter.MasterGhostwriter) ghostwriter;
        ...
        throws Exception
    {
        ...
        {
            final Ghostwriter.SlaveGhostwriter slaveBuildStep = (Ghostwriter.SlaveGhostwriter) ghostwriter;
            try
            {
