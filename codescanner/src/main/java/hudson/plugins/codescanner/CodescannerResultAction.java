...
public class CodescannerResultAction extends AbstractResultAction<CodescannerResult> {
     ...
     */
    public CodescannerResultAction getPreviousResultAction() {
        AbstractResultAction<CodescannerResult> previousBuild = getPreviousBuild();
        if (previousBuild instanceof CodescannerResultAction) {
            return (CodescannerResultAction)previousBuild;
        }
