...
const AUDIOS_DIR = rootUrl + '/plugin/jsgames/mariokart/resources/';
const IMAGES_DIR = rootUrl + '/plugin/jsgames/mariokart/resources/';
const CONTAINER = document.getElementById('mariokart_container');

var oMaps = {
	"map1" : {
		"texture" : IMAGES_DIR + "map_1.png",
		"width" : 512,
		"height" : 512,
		"collision" : [
			[84,80,52,216],
...
function startGame() {
	...
	oCountImg.src = IMAGES_DIR + "countdown.png";
...
function startMusic() {
	...
	oMusicEmbed.src = AUDIOS_DIR + strMap + ".mid";
...
function Sprite(strSprite) 
{
	...
	oImg.src = IMAGES_DIR + "sprite_" + strSprite + (bSmoothSprites ? "_smooth" : "") + ".png";
...
function BGLayer(strImage, iLayerWidth) {
	...
	oImg1.src = IMAGES_DIR + "bg_" + strImage + ".png";
	...
	oImg2.src = IMAGES_DIR + "bg_" + strImage + ".png";
	...
	function selectPlayerScreen() {
		...
		oTitle.src = IMAGES_DIR + "title.png";
		...
		for (var i=0;i<aPlayers.length;i++) {
			...
			oPImg.src = IMAGES_DIR + "select_" + aPlayers[i] + ".png";
	...
	function selectMapScreen() {
		...
		var oTitle = document.createElement("img");
		oTitle.src = IMAGES_DIR + "mushroomcup.png";
		oTitle.style.position = "absolute";
		...
		for (var i=0;i<aAvailableMaps.length;i++) {
			var oPImg = document.createElement("img");
			oPImg.src = IMAGES_DIR + "select_" + aAvailableMaps[i] + ".png";
	...
	for (var i=0;i<aPlayers.length;i++) {
		var oImg = new Image();
		oImg.src = IMAGES_DIR + "sprite_" + aPlayers[i] + "_smooth.png";
	}
